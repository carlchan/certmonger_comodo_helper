...
Version: %{version}
Release: %{release}
Source0: https://github.com/erinn/certmonger_comodo_helper/archive/%{unmangled_version}.tar.gz#/%{pkg_name}-%{unmangled_version}.tar.gz
License: AGPL-3.0
...
Requires: %req
BuildArch: noarch
BuildRequires: python2-devel python-setuptools python-suds
